...
export function HomeButtons({
  ...
  return (
    <div className="flex flex-wrap items-center justify-start gap-4 lg:gap-5 w-full mt-4">
      ...
      <Button variant="outline" asChild size="lg" className="h-12 md:h-14 px-8 text-base md:text-lg font-black group bg-emerald-300 hover:bg-emerald-200 active:bg-emerald-400 text-slate-900 transition-all rounded-full cursor-pointer border-[3px] border-slate-900 shadow-[4px_4px_0_0_rgb(15,23,42,1)]  hover:shadow-[6px_6px_0_0_rgb(15,23,42,1)] hover:-translate-y-1 active:translate-y-1 active:shadow-none hover:-rotate-1 duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)]">
