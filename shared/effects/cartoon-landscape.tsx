...
export function CartoonLandscape() {
  return (
    <div className="absolute inset-0 pointer-events-none overflow-hidden">
      ...
      {/* 统一风格的高颜值云朵 1 (左上方横穿) */}
      <div className="absolute top-[8vh] md:top-[12vh] lg:top-[15vh] left-[10%] md:left-[8%] lg:left-[12%] w-32 md:w-48 lg:w-64 h-16 md:h-24 lg:h-32 animate-[slide_60s_linear_infinite] opacity-40 md:opacity-30 z-20 pointer-events-none">
        <CloudSvg />
      </div>

      {/* 统一风格的高颜值云朵 2 (右上极高处) */}
      <div className="absolute top-[10vh] md:top-[8vh] lg:top-[10vh] right-[10%] md:right-[15%] lg:right-[20%] w-24 md:w-40 lg:w-56 h-12 md:h-20 lg:h-28 animate-[slide-reverse_70s_linear_infinite] opacity-40 md:opacity-30 z-20 pointer-events-none">
        <CloudSvg />
      </div>
      ...
      {/* 添加了一朵低空的云朵 */}
      <div className="absolute top-[75vh] lg:top-[60vh] right-[15%] md:right-[15%] lg:right-[20%] w-20 md:w-28 lg:w-40 h-10 md:h-14 lg:h-20 animate-[slide_90s_linear_infinite] opacity-40 md:opacity-30 z-20 pointer-events-none">
        <CloudSvg />
      </div>

      {/* 涂鸦纸飞机 1 */}
      <div className="absolute top-[65vh] md:top-[55vh] lg:top-[65vh] left-[15%] md:left-[20%] lg:left-[40%] w-8 md:w-8 lg:w-12 h-8 md:h-8 lg:h-12 animate-[slide_45s_linear_infinite] opacity-60 md:opacity-50 hover:opacity-100 transition-opacity z-20">
      ...
      {/* 涂鸦纸飞机 2 */}
      <div className="absolute top-[20vh] md:top-[25vh] lg:top-[28vh] right-[15%] md:right-[30%] lg:right-[38%] w-6 md:w-6 lg:w-10 h-6 md:h-6 lg:h-10 animate-[slide-reverse_35s_linear_infinite] delay-500 opacity-60 md:opacity-40 hover:opacity-100 transition-opacity z-20 block">
      ...
      {/* 涂鸦小鸟飞越 (两只) */}
      <div className="absolute top-[25vh] md:top-[18vh] lg:top-[20vh] left-[15%] md:left-[15%] lg:left-[25%] w-6 md:w-6 lg:w-8 h-4 md:h-4 lg:h-6 animate-[slide_40s_linear_infinite] opacity-60 md:opacity-40 z-20">
      ...
      <div className="absolute top-[22vh] md:top-[16vh] lg:top-[18vh] left-[13%] md:left-[13%] lg:left-[23%] w-4 md:w-4 lg:w-6 h-3 md:h-3 lg:h-5 animate-[slide_40s_linear_infinite] delay-150 opacity-40 md:opacity-30 z-20">
         <svg viewBox="-5 -5 34 34" className="w-full h-full text-slate-500 dark:text-slate-400 overflow-visible">
            <path d="M2 12 Q 7 5, 12 12 Q 17 5, 22 12" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
         </svg>
      </div>
      ...
      {/* 手绘热气球 */}
      <div className="absolute top-[12vh] md:top-[15vh] lg:top-[22vh] right-[15%] md:right-[5%] lg:right-[8%] w-12 md:w-12 lg:w-20 h-16 md:h-16 lg:h-24 animate-[slide-reverse_120s_linear_infinite] delay-1000 opacity-60 md:opacity-40 hover:opacity-100 transition-opacity z-20 block">
      ...
      {/* 卡通太阳/星球 (高处背景) */}
      <div className="absolute top-[8vh] md:top-[8vh] lg:top-[12vh] right-[10%] md:right-[15%] lg:right-[20%] w-16 md:w-24 h-16 md:h-24 text-yellow-300 fill-yellow-100 dark:text-yellow-500/60 dark:fill-yellow-500/10 animate-[spin_40s_linear_infinite] opacity-40 md:opacity-60 z-[20]">
